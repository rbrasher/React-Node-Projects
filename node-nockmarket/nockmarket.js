...
app.configure(function() {
    ...
    app.use(express.session({secret: 'Y##WBk9o7*fQTdA@kzQ3sUbvgRzd2)QC7FalO9yy3D$yGqlQO1v6xxcD$CGRx])g', store: nocklib.getSessionStore()}));
